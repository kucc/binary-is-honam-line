...
export const UPLOAD_MY_IMAGE_REQUEST = 'UPLOAD_MY_IMAGE_REQUEST';
export const UPLOAD_MY_IMAGE_SUCCESS = 'UPLOAD_MY_IMAGE_SUCCESS';
export const UPLOAD_MY_IMAGE_FAILURE = 'UPLOAD_MY_IMAGE_FAILURE';
